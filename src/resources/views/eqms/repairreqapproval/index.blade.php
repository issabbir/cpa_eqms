                            ...
                            <div class="card-content">
                                <div class="card-body">
                                    <form enctype="multipart/form-data"
                                          @if(isset($mData->r_r_mst_id)) action="{{route('repair-request-approval-update',[$mData->r_r_mst_id])}}"
                                          @endif method="post">
                                        @csrf
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table table-sm table-striped table-bordered"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th role="columnheader" scope="col"
                                                                aria-colindex="1" class="text-center" width="20%">
                                                                Repairing Workshop
                                                            </th>
                                                        </tr>
                                                        </thead>
                                                        ...
                                                        @if(!empty($dData2))
                                                            @foreach($dData2 as $key=>$value)
                                                                <tr role="row">
                                                                    ...
                                                                    <td aria-colindex="7" role="cell">
                                                                        <select
                                                                            class="custom-select form-control tab_workshop_id"
                                        ...
                                        <div class="form-group mt-1">
                                            <div class="col-md-12 pr-0 d-flex justify-content-end">
                                                <div class="form-group">
                                                    ...
                                                    @endif
                                                    <a type="reset" href="{{route("repair-request-approval-index")}}"
                                                    ...
                                                    <form id="workflow_submit" method="post">
                                                        ...
                                                        <fieldset class="border p-1 mt-2 mb-1 col-sm-12"
                                                            ...
                                                            <input type="hidden" id="malfunction_id"
                                                                   name="malfunction_id">
                                                            <input type="hidden" id="malfunction_other"
                                                                   name="malfunction_other">
                                                            <input type="hidden" id="workshop_id_hid"
                                                                   name="workshop_id">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="form-group">
...
@section('footer-script')
    ...
    <script type="text/javascript">
        ...
        function commentWin(app_eqr_id, approval_info_id, apprv_status) {
            ...
            const tab_r_r_d_id = [];
            const tab_malfunction_id = [];
            const tab_malfunction_other = [];
            const tab_workshop_id = [];
            $.each(arr, function (i, fd) {
                if (fd.name === "tab_r_r_d_id[]") {
                    tab_r_r_d_id.push(fd.value);
                }
                if (fd.name === "tab_malfunction_id[]") {
                    tab_malfunction_id.push(fd.value);
                }
                if (fd.name === "tab_malfunction_other[]") {
                    tab_malfunction_other.push(fd.value);
                }
                if (fd.name === "tab_workshop_id[]") {
                    tab_workshop_id.push(fd.value);
                }
            });
            $("#r_r_d_id").val(tab_r_r_d_id);
            $("#malfunction_id").val(tab_malfunction_id);
            $("#malfunction_other").val(tab_malfunction_other);
            $("#workshop_id_hid").val(tab_workshop_id);
