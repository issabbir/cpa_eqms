                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form enctype="multipart/form-data"
                                      ...
                                      @else action="{{ route('add-equipment-post') }}" @endif
                                      method="post">
                                    @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" placeholder="Equipment No" name="equip_no"
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" autocomplete="off" placeholder="Equipment Name"
                                                   name="equip_name" class="form-control"
                                        ...
                                        <div class="col-md-3" id="hide6">
                                            <label class="required" id="reqCls">LOAD CAPACITY</label>
                                            <select class="custom-select select2 form-control" id="load_capacity_id"
                                                    required name="load_capacity_id">
                                                <option value="">Select One</option>
                                        ...
                                        <div class="col-md-3 mt-1" id="emMargin">
                                            <label>EQUIPMENT MODEL</label>
                                            <input type="text" autocomplete="off" placeholder="Equip Model"
                                                   name="equip_model" class="form-control"
                                        ...
                                        <div class="col-md-3 mt-1">
                                            ...
                                            <input type="text" autocomplete="off" placeholder="Manufacturer Name"
                                                   name="manufacturer_name" class="form-control"
                                        ...
                                        <div class="col-md-6 mt-1">
                                            ...
                                            <input type="text" autocomplete="ok" placeholder="Manufacturer Address"
                                                   name="manufacturer_address" class="form-control"
                                        ...
                                        <div class="col-md-3 mt-1">
                                            ...
                                            <input type="text" autocomplete="off" placeholder="Engine Model"
                                                   name="engine_model" class="form-control"
                                        ...
                                        <div class="col-md-3 mt-1">
                                            ...
                                            <input type="text" autocomplete="off" placeholder="Engine Sl No"
                                                   name="engine_sl_no" required class="form-control"
                                        ...
                                        <div class="col-md-3 mt-1">
                                            ...
                                            <input type="text" autocomplete="off" placeholder="Chassis No"
                                                   name="chassis_no" class="form-control"
                                        ...
                                        <div class="col-md-3 mt-1">
                                            ...
                                            <input type="number" autocomplete="off" placeholder="Manufacture Year"
                                                   name="manufacture_year" class="form-control"
                                        ...
                                        <div class="col-md-3 mt-1">
                                            <label>BHP RPM</label>
                                            <input type="text" autocomplete="off" placeholder="BHP RPM"
                                                   name="bhp_rpm" class="form-control"
                                        ...
                                        <div class="col-md-3 mt-1">
                                            ...
                                            <input type="text" autocomplete="off" placeholder="Transmission Model"
                                                   name="trans_model" class="form-control"
                                                   value="{{ isset($data->trans_model) ? $data->trans_model : '' }}">
                                        </div>
                                        <div class="col-md-3 mt-1">
                                            <label>Spreder Model</label>
                                            <input type="text" autocomplete="off" placeholder="Spreder Model"
                                                   name="speder_model" class="form-control"
                                        ...
                                        <div class="col-md-3 mt-1">
                                            ...
                                            <input type="text" autocomplete="off" placeholder="Fuel Tank Capacity"
                                                   name="fuel_tank_capacity" class="form-control"
                                        ...
                                        <div class="col-md-3 mt-1 mb-1">
                                            ...
                                            <div class="input-group date datePiker">
                                                <input type="text"
                                                       {{-- @if (isset($data->operation_date)) disabled @endif --}} autocomplete="off"
                                                       class="form-control datetimepicker-input"
                                                       data-toggle="datetimepicker"
                                                       id="operation_date" data-target="#operation_date"
                                                       name="operation_date"
                                                ...
                                                {{--                                                           value="{{old('operation_date',isset($data->operation_date) ? date('d-m-Y', strtotime($data->operation_date)) : '')}}"> --}}
                                                {{--                                                @endif --}}
                                        ...
                                        <div class="col-md-3 mt-1 mb-1">
                                            ...
                                            <div class="input-group date datePiker">
                                                <input type="number"
                                                       {{-- @if (isset($data->economical_life)) readonly @endif --}} class="form-control"
                                                       id="economical_life" name="economical_life"
                                        ...
                                        <div class="col-md-3 mt-1 mb-1">
                                            ...
                                            <div class="input-group date datePiker">
                                                <input type="text" disabled class="form-control" id="date_expire">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3 mt-1 mb-1">
                                            ...
                                            <div class="input-group date datePiker">
                                                <input type="text" disabled class="form-control" id="rem_ec_lyf">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3 mt-1">
                                            ...
                                            <div class="input-group date datePiker">
                                                <input type="text"
                                                       {{-- @if (isset($data->contract_date)) readonly @endif --}} autocomplete="off"
                                                       class="form-control datetimepicker-input"
                                                       data-toggle="datetimepicker"
                                                       id="contract_date" data-target="#contract_date"
                                                       name="contract_date"
                                                ...
                                                {{--    <input type="hidden" name="contract_date" --}}
                                                {{--    value="{{old('contract_date',isset($data->contract_date) ? date('d-m-Y', strtotime($data->contract_date)) : '')}}"> --}}
                                                {{--@endif --}}
                                        ...
                                        <div class="col-md-3 mt-1">
                                            ...
                                            <input type="text" autocomplete="off" placeholder="Contract No"
                                                   name="contract_no" class="form-control"
                                        ...
                                        <div class="col-md-3 mt-1">
                                            ...
                                            <input type="number" autocomplete="off" placeholder="Contract Value"
                                                   name="contract_value" class="form-control"
                                                   value="{{ isset($data->contract_value) ? $data->contract_value : '' }}">
                                        </div>
                                        <div class="col-md-3 mt-1">
                                            <label>SUPPLIER NAME</label>
                                            <input type="text" autocomplete="off" placeholder="Supplier Name"
                                        ...
                                        <div class="col-md-3 mt-1">
                                            ...
                                            <input type="text" autocomplete="ok" placeholder="Supplier Address"
                                        ...
                                        <div class="col-md-3 mt-1">
                                            <label class="required">MANAGEMENT WORKSHOP</label>
                                            @if($adminYes == 'true')
                                                <select class="custom-select select2 form-control" required
                                                        id="l_workshop_id" name="l_workshop_id">
                                                    <option value="">Select One</option>
                                                    @foreach ($lWorkshopList as $value)
                                                        <option value="{{ $value->workshop_id }}"
                                                            {{ isset($data->workshop_id) && $data->workshop_id == $value->workshop_id ? 'selected' : '' }}>
                                            ...
                                            @else
                                                <select class="custom-select select2 form-control" required
                                                        id="l_workshop_id" name="l_workshop_id">
                                                    <option
                                                        value="{{ !empty($lWorkshopList) ? $lWorkshopList->workshop_id : ( empty($data->workshop_id) ? '' : $data->workshop_id ) }}"> {{ !empty($lWorkshopList) ? $lWorkshopList->workshop_name : (  empty($data->workshop_name) ?  '' : $data->workshop_name)  }}</option>
                                                </select>
                                            @endif
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                ...
                                                <input type="text" autocomplete="off"
                                                       placeholder="Equipment Short Name" name="equip_short_name"
                                                       class="form-control"
                                            ...
                                            <div class="col-md-3 mt-1">
                                                ...
                                                <input type="text" autocomplete="off" placeholder="Machine Name"
                                                       name="machine_name" class="form-control"
                                            ...
                                            <div class="col-md-3 mt-1">
                                                ...
                                                <input type="text" autocomplete="off" placeholder="Equipment Sl No"
                                                       name="equip_sl_no" class="form-control"
                                            ...
                                            <div class="col-md-3 mt-1">
                                                ...
                                                <input type="text" autocomplete="off" placeholder="Engine Type"
                                                       name="engine_type" class="form-control"
                                            ...
                                            <div class="col-md-3 mt-1">
                                                <label>BORE MM</label>
                                                <input type="text" autocomplete="off" placeholder="BORE MM"
                                                       name="bore_mm" class="form-control"
                                            ...
                                            <div class="col-md-3 mt-1">
                                                ...
                                                <input type="text" autocomplete="off" placeholder="Compression Ratio"
                                                       name="compressore_ratio" class="form-control"
                                            ...
                                            <div class="col-md-3 mt-1">
                                                ...
                                                <input type="text" autocomplete="off" placeholder="Max Lift Height"
                                                       name="max_lift_height" class="form-control"
                                            ...
                                            <div class="col-md-3 mt-1">
                                                ...
                                                <input type="text" autocomplete="off" placeholder="Lift Speed Laden"
                                                       name="lift_speed_laden" class="form-control"
                                            ...
                                            <div class="col-md-3 mt-1">
                                                ...
                                                <input type="text" autocomplete="off" placeholder="Lift Speed Unladen"
                                                       name="lift_speed_unladen" class="form-control"
                                            ...
                                            <div class="col-md-3 mt-1">
                                                ...
                                                <input type="text" autocomplete="off" placeholder="Lower Speed Laden"
                                                       name="lower_speed_laden" class="form-control"
                                            ...
                                            <div class="col-md-3 mt-1">
                                                ...
                                                <input type="text" autocomplete="off"
                                                       placeholder="Lower Speed Unladen" name="lower_speed_unladen"
                                                       class="form-control"
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div id="start-no-field" class="form-group">
                                                    ...
                                                    <input type="text" id="case_doc_name" class="form-control "
                                                                    ...
                                                                    <td>
                                                                        @if (isset($value->files))
                                                                            <a href="{{ route('file-download', [$value->doc_id]) }}"
                                                                               target="_blank"><i
                                                                                    class='bx bxs-download cursor-pointer'></i></a>
                                                                        @endif
                                                                    </td>
                                                                </tr>
                                                            @endforeach
    ...
    <script type="text/javascript">
        ...
        $("#equip_type_id").on('change', function (e) {
            ...
            if (equip_type_id == '3' || equip_type_id == '4') {
                ...
                $("#reqCls").removeClass("required");
                $("#load_capacity_id").removeAttr("required");
                $("#emMargin").removeClass("mt-1");


            } else {
                $('#hide6').css("display", "block");
                $("#reqCls").addClass("required");
                $("#load_capacity_id").attr("required");
                $("#emMargin").addClass("mt-1");
            }
        });
