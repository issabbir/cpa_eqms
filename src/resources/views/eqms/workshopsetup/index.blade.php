                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form enctype="multipart/form-data"
                                    ...
                                    <h5 class="card-title">Repair Workshop Setup</h5>
                                    <hr>
                                    <div class="row">
                                        <div class="col-md-3 mt-1">
                                            <label class="required">Management Workshop Type</label>
                                        ...
                                        <div class="col-md-3 mt-1">
                                            <label class="required">Management Workshop Name</label>
                                        ...
                                        <div class="col-md-3 mt-1">
                                            <label>Management Workshop Name (Bangla)</label>
                                            <input type="text" autocomplete="off"
                                        ...
                                        <div class="col-md-3 mt-1">
                                            <label>Management Workshop Address</label>
                                            <input type="text" autocomplete="off"
