                                        ...
                                        <div class="col-md-4 mt-1">
                                            ...
                                            >
                                                ...
                                                @foreach($equipment_dropdown as $value)
                                                    ...
                                                    >
                                                        {{!empty($edit_data['equipment_id']) && $value->equip_id ==  $edit_data['equipment_id']  ? $edit_data['equipment'] : $value->equip_name}}
                                                    </option>
                                            ...
                                            <div class="form-group">
                                                ...
                                                @if((!empty($edit_data->is_demand_yn) && ($edit_data->is_demand_yn == 'N' ||  $edit_data->is_demand_yn == 'P')) )
                                                    ...
                                                    @if($edit_data['is_demand_yn']== 'N' || $edit_data['is_demand_yn']== 'P' )
                                                        ...
                                                        @if($edit_data['is_demand_yn']== 'P')
                                                            <a target="_blank"
                                                               href="{{externalLoginUrl($url, '/item-demand/' . $edit_data->item_demand_id)}}"
