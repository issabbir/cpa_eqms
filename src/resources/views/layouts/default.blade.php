...
<head>
    ...
    <title>CPA  @yield('title', 'Equipment Maintenance System')</title>
...
<script src="{{asset('assets/js/scripts/jquery.multi-select.js')}}"></script>
<script src="{{asset('assets/js/scripts/jquery.quicksearch.js')}}"></script>
<script src="{{asset('assets/js/scripts/tags.js')}}"></script>
